  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-black text-white">
        <div className="relative aspect-[16/9] md:aspect-[21/9]">
          ...
          <motion.div
            ...
            className="absolute inset-0 flex flex-col items-center justify-end text-center px-6 pb-12 md:pb-20"
          >
      ...
      {byCategory.map((cat, i) => (
        <Reveal key={cat.slug}>
          <section className={i % 2 === 0 ? "bg-background" : "bg-muted/30"}>
            <div className="container mx-auto px-4 py-16 md:py-24">
              <div className="grid md:grid-cols-2 gap-10 items-center mb-10">
                ...
                <div className={`group relative aspect-[4/3] rounded-2xl overflow-hidden bg-muted ${i % 2 === 1 ? "md:order-1" : ""}`}>
                  <img
