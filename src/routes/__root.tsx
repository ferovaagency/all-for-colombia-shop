...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Tienda online en Colombia: tecnología, hogar, equipos corporativos, aires acondicionados y plóters. Envíos a todo el país." },
      ...
      { name: "twitter:description", content: "Tienda online en Colombia: tecnología, hogar, equipos corporativos, aires acondicionados y plóters. Envíos a todo el país." },
