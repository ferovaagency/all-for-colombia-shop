      ...
      <div className="container mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-primary-foreground/75">
            ...
            <li className="flex items-start gap-2"><Phone className="h-4 w-4 mt-0.5" /> <a href="https://wa.me/573134977955" className="hover:text-white">+57 3134977955</a></li>
          </ul>
        </div>
      </div>
      <div className="border-t border-white/10 py-4">
        <div className="container mx-auto px-4 flex flex-col items-center gap-2">
          ...
          <div className="flex flex-wrap justify-center gap-2">
            {["🏛️ PSE Openpay", "📲 QR Bre-B", "🏦 Bancolombia", "🏦 Davivienda", "📱 Nequi"].map((m) => (
              <span
                key={m}
