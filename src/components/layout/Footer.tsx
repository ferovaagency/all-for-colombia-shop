      ...
      <div className="container mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          ...
          <p className="text-sm text-primary-foreground/75 leading-relaxed">
            Tecnología confiable con respaldo real. Más de 10 años llevando los mejores productos a
            todo Colombia.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-primary-foreground/75">
            ...
            <li>
              <Link to="/ventas-corporativas" className="hover:text-white">
                Ventas Corporativas
              </Link>
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-primary-foreground/75">
            ...
            <li>
              <Link to="/mi-cuenta" className="hover:text-white">
                Mi cuenta
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-primary-foreground/75">
            ...
            <li className="flex items-start gap-2">
              <Clock className="h-4 w-4 mt-0.5" /> Lun-Vie 8am-5pm | Sáb 9am-1pm
            </li>
            <li className="flex items-start gap-2">
              <Mail className="h-4 w-4 mt-0.5" /> {CONTACT_EMAIL}
            </li>
            <li className="flex items-start gap-2">
              <Phone className="h-4 w-4 mt-0.5" />{" "}
              <a href="https://wa.me/573134977955" className="hover:text-white">
                +57 3134977955
              </a>
            </li>
          </ul>
      ...
      <div className="border-t border-white/10 py-4">
        <div className="container mx-auto px-4 flex flex-col items-center gap-2">
          ...
          <div className="flex flex-wrap justify-center gap-2">
            {["🏛️ PSE Openpay", "📲 QR Bre-B", "🏦 Bancolombia", "🏦 Davivienda", "📱 Nequi"].map(
              (m) => (
                <span
                  key={m}
