...
export function SocialProofPopup() {
  ...
  return (
    <div
      role="status"
      aria-live="polite"
      className={`fixed left-3 bottom-[calc(max(1.5rem,env(safe-area-inset-bottom))+4.25rem)] z-40 w-[min(20rem,calc(100vw-1.5rem))] sm:left-6 transition-all duration-200 ease-out ${
        visible
